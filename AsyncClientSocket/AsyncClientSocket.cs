...
namespace AsynchronousClientSocket
{
    ...
    public class AsyncClientSocket : IDisposable
    {
        ...
        public delegate void delDataReceived(AsyncClientSocket sender, object data);
        public event delDataReceived DataReceived;
        public delegate void delConnectionStatusChanged(AsyncClientSocket sender, ConnectionStatus status);
        ...
        public AsyncClientSocket(IPAddress ip, int port, bool autoreconnect = true)
        {
            this._IP = ip;
            this._Port = port;
        ...
        {
            var r = result.AsyncState as AsyncClientSocket;
            if (r == null)
